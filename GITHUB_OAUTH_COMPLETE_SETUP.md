...
## Overview
This guide will help you set up GitHub OAuth authentication for your 0cto Slack bot, so users can connect their GitHub accounts and create issues directly from Slack.
...
### How It Works:
1. **User runs** `/0cto create-issue` in Slack
