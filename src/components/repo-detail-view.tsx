...
export function RepoDetailView({ repoFullName }: RepoDetailViewProps) {
    ...
    return (
      <div className="flex flex-col flex-1 items-center justify-center gap-4 p-8 text-center">
        ...
        <p className="text-muted-foreground max-w-md">
          The 0cto AI is currently inspecting the repository structure and documentation to get up to speed. This may take a moment.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
    <div className="flex flex-1 justify-center p-4 sm:p-8 bg-transparent overflow-y-auto">
