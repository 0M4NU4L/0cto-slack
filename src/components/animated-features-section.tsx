        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="Track & Grow"
              subtitle="Monitor your contributions, discover new projects, and grow your open source portfolio"
          ...
          <BentoCard
            ...
            value="Native"
            subtitle="Seamless GitHub connectivity"
          ...
          <div className="md:col-span-2">
            <BentoCard
              ...
              value="Collaborate"
              subtitle="Connect with maintainers, contribute to issues, and build meaningful relationships"
          ...
          <div className="md:col-span-3">
            <BentoCard
              ...
              value="Insights"
              subtitle="Track your impact with detailed analytics on commits, PRs, issues, and code reviews"
