...
export function SlackIntegration({ 
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <CardDescription>
                  Connect 0cto to your Slack workspace for seamless issue tracking
                </CardDescription>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">Use /0cto in Slack</p>
                </div>
                <div className="text-center p-4 border rounded-lg">
                ...
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">@0cto for help</p>
                </div>
              </div>
            </div>
          ) : (
      ...
      {isConnected && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Customize how 0cto works in your Slack workspace
            </CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>How to Use 0cto in Slack</CardTitle>
          <CardDescription>
            Quick guide to get started with 0cto commands and features
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Use <code className="bg-gray-100 px-1 rounded">/0cto analyze</code> or 
                  <code className="bg-gray-100 px-1 rounded ml-1">/0cto create-issue</code> for manual control
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Add 0cto to channels where development discussions happen</li>
